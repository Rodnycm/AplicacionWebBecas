...
namespace EntitiesLayer
{
    public class Usuario : IEntity
    {
        ...
        public Usuario(String ppNombre, String psNombre, String ppApellido, String psApellido, String pidentificacion, String ptelefono, DateTime pfechaNacimiento, Rol prol, int pgenero,
            String pcorreoElectronico, String pcontraseña, Carrera pcarrera)
        {
            DateTime fecha = pfechaNacimiento.Date;
            Id = 0;
            primerNombre = ppNombre;
