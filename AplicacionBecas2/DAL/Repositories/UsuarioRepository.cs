...
namespace DAL.Repositories
{
    public class UsuarioRepository : IRepository<Usuario>
    {
        ...
        public Usuario GetById(int id)
        {
            ...
            DataSet ds = DBAccess.ExecuteSPWithDS(ref cmd, "Sp_buscarUsuarioId");
            Rol rolUsuario = null; 
            if (ds.Tables[0].Rows.Count > 0)
            {
        ...
        public void InsertUsuarioEstudiante(Usuario objUsuario)
        {
            try
            {
                SqlCommand cmd = new SqlCommand();
                ...
                cmd.Parameters.Add(new SqlParameter("@correoElectronico", objUsuario.correoElectronico));
                cmd.Parameters.Add(new SqlParameter("@contraseña", objUsuario.contraseña));
                cmd.Parameters.Add(new SqlParameter("@carrera", objUsuario.carrera.nombre));

                DataSet ds = DBAccess.ExecuteSPWithDS(ref cmd, "Sp_agregarEstudiante");
